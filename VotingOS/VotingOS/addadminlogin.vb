...
Public Class addadminlogin
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf userFound = True And Level = "Additional Admin" Then
            Me.Close()
            addadminconfig.Show()
    ...
    Private Sub addadminlogin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Clear()
